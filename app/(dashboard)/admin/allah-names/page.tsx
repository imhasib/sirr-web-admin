  ...
  return (
    ...
    >
      <ListPageLayout
        ...
        alertBanner={{
          icon: Info,
          title: 'Sacred Constants',
          description: "The 99 names of Allah are sacred constants. You can edit existing names to fix typos or improve descriptions, but cannot create new names or delete existing ones.",
        }}
        emptyState={{
          icon: Book,
